...
#include "nebula/common/base/Helpers.h"
#include "nebula/common/thread/NamedThread.h"
...
class GenericWorker final : public nebula::NonCopyable, public nebula::NonMovable {
public:
